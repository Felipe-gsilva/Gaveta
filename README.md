...
**Gaveta** is a (WIP) database storage engine written in pure C, focusing in raw performance and mainly in my personal desires (the joy of writing C code and learning in the process). 
